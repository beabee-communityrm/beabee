...
export class AddApiKeys1681638985427 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "joined" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "api_user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "joined" TIMESTAMP NOT NULL DEFAULT now(), "creatorId" uuid, "apiKeyId" character varying NOT NULL, "apiKeySecrethash" character varying NOT NULL, CONSTRAINT "PK_8eb953e69be312b10c2d8e060c4" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "user_role" ("type" character varying NOT NULL, "dateAdded" TIMESTAMP NOT NULL DEFAULT now(), "dateExpires" TIMESTAMP, "userId" uuid NOT NULL, CONSTRAINT "PK_103ec7e34dba94d88e1d84becad" PRIMARY KEY ("type", "userId"))`);
        ...
        await queryRunner.query(`ALTER TABLE "api_user" ADD CONSTRAINT "FK_ffa754cdda66921faf1171cf0ab" FOREIGN KEY ("creatorId") REFERENCES "contact"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "callout_response_comment" DROP CONSTRAINT "FK_81b0d2a988cfd8d34ad7fc3bb68"`);
        await queryRunner.query(`ALTER TABLE "callout_response_comment" DROP CONSTRAINT "FK_49079a033f285ccfa789aba2efa"`);
        await queryRunner.query(`ALTER TABLE "api_user" DROP CONSTRAINT "FK_ffa754cdda66921faf1171cf0ab"`);
