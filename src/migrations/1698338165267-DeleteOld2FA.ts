...
export class DeleteOld2FA1698338165267 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "contact" ADD "otpKey" character varying`);
        await queryRunner.query(`ALTER TABLE "contact" ADD "otpActivated" boolean NOT NULL DEFAULT false`);
    }
