...
export class AddContactMfa1698418165066 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "contact_mfa" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "type" character varying NOT NULL, "secret" character varying NOT NULL DEFAULT '', "contactId" uuid, CONSTRAINT "REL_c40227151c460b576a5670bdac" UNIQUE ("contactId"), CONSTRAINT "PK_d40458d0b855b5337eab082f69c" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
